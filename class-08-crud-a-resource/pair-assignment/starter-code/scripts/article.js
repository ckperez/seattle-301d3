(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(
      [
        {
          'sql': 'CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY, title VARCHAR(255), author VARCHAR(255), author_url VARCHAR(255), category VARCHAR(255), published_on VARCHAR(255), body VARCHAR(255))'
        }
  ...
  Article.prototype.insertRecord = function(callback) {
    webDB.execute(
      [
        {
          'sql': 'INSERT INTO articles (title, author, author_url, category, published_on, body) VALUES (?, ?, ?, ?, ?, ?)',
      ...
      if (rows.length) {
        ...
        $.getJSON('/data/hackerIpsum.json', function(data) {
          ...
          data.forEach(function(obj) {
            ...
            article.insertRecord(); // This will instantiate an article instance based on each article object from our JSON.
            // DONE:
